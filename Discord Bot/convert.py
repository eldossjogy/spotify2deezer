...
def main(spotifyLink,deezerToken):
    ...
    if totalTracks <= 2000:
        ...
        print("Tracks Found on Deezer (" + str(tracksFound)+"):") 
        ...
        if tracksFailed != totalTracks:
            ...
            print('Done!')
            deezerPlaylistID = 'https://www.deezer.com/playlist/' + str(deezerPlaylistID)
            print(failSongs)
            return (True,deezerPlaylistID,tracksFound,tracksFailed,failSongs,localSongs)
        else:
            return (False, 'Failed')
    else:
        return (False,'Playlist Total Track Exceeds 2000 Limit')